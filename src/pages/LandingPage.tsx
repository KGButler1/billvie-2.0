    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <BillvieLogo size="md" />
          <Button onClick={() => navigate("/onboarding")} className="btn-hero text-sm py-2 px-4">
            Get Started
          </Button>
        </div>
      </header>
        ...
        <div className="container mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={() => navigate("/onboarding")} className="btn-hero text-lg">
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto">
          ...
          >
            "Most households rely on one person knowing everything. Bills, logins, deadlines — all in one head. Billvie
            makes sure that's never a problem."
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-secondary/30">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Less mental load, more peace of mind</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-3">It takes two minutes to start</h2>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Add one bill, one contact, or one document — and your household is already better prepared.
            </p>
            <Button onClick={() => navigate("/onboarding")} className="btn-hero">
      ...
      <section className="py-20 px-4 bg-secondary/30">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">Start free. Upgrade when your household needs more.</p>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Your family will thank you</h2>
      ...
      <footer className="border-t border-border py-12 px-4">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Billvie. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
