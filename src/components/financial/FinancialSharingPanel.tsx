...
import FinancialAccessSheet from '@/components/financial/FinancialAccessSheet';

export const FinancialSharingPanel = () => {
  const [people, setPeople] = useState<TrustedPerson[]>([]);
  const [isOpen, setIsOpen] = useState(false);

  const reload = () => setPeople(AccessService.getPeopleWithAccessTo('financial_info'));
        ...
        <div className="bg-card rounded-xl border border-border p-4 mb-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="font-medium">No one can see your financial snapshot yet</h3>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium truncate">
              {people.map((p) => p.name).join(', ')} can see your financial snapshot
            </p>
